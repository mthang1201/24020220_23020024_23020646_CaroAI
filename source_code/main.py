import argparse
import sys
from source_code.config import BOARD_SIZE, DEFAULT_UI, DEFAULT_DEPTH_MINIMAX, DEFAULT_DEPTH_ALPHABETA, DEFAULT_TIME_LIMIT_EASY, DEFAULT_TIME_LIMIT_MEDIUM, DEFAULT_TIME_LIMIT_HARD
...
def main():
    ...
    if depth_choice == "1":
        ...
        default_time_limit = DEFAULT_TIME_LIMIT_EASY
    elif depth_choice == "3":
        DEFAULT_DEPTH_MINIMAX = 5
        DEFAULT_DEPTH_ALPHABETA = 8
        default_time_limit = DEFAULT_TIME_LIMIT_HARD
    else:
        DEFAULT_DEPTH_MINIMAX = 4
        DEFAULT_DEPTH_ALPHABETA = 6
        default_time_limit = DEFAULT_TIME_LIMIT_MEDIUM
    ...
    parser.add_argument("--time_limit", type=float, default=default_time_limit, help="Time limit for AI thinking (seconds)")
